...
public class ScriereInAudit {
    ...
    public void stergeDinAudit() throws IOException {
        FileWriter FW = new FileWriter("D:\\proiect_pao\\proiect_pao\\GestionareStructuraEchipaDeFormula1\\src\\gestionareStructuraEchipaDeFormula1\\fisiere\\audit.csv", false);
    ...
    public void scrieInAudit(String comanda) throws IOException {
        FileWriter FW = new FileWriter("D:\\proiect_pao\\proiect_pao\\GestionareStructuraEchipaDeFormula1\\src\\gestionareStructuraEchipaDeFormula1\\fisiere\\audit.csv", true);
        BufferedWriter text = new BufferedWriter(FW);
        text.append(comanda);
        text.append(",");
